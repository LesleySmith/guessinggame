...
class Game {
    ...
    playersGuessSubmission(aNum) {
        if (aNum > 100 || aNum < 1 || isNaN(aNum)) {
            document.getElementById('message').innerHTML = `Sorry, ${aNum} isn't a valid input.`;
    ...
    checkGuess() {
        ...
        if (parseInt(this.playersGuess) === this.winningNumber) {
            ...
            if (this.pastGuesses.length === 5) {
                ...
                if(diffNum < 10) {
                    messageDisplay = "You're burning up!";
                }
                else if(diffNum < 25) {
                    messageDisplay = "You're lukewarm.";
                }
                else if(diffNum < 50) {
                    messageDisplay = "You're a bit chilly.";
                }
                else {
